...
def list_cameras():
    from core.camera import list_cameras as _list
    return jsonify(cameras=_list(max_test=6))


@bp.route('/set_camera')
def set_camera():
    from core.camera import set_camera_index
...
def camera_settings():
    from core.camera import _camera_index, FRAME_W, FRAME_H, FRAME_FPS, _is_dummy, RESOLUTION_PRESETS, FPS_PRESETS
    return jsonify(
...
def set_camera_resolution():
    from core.camera import set_camera_resolution
...
def set_camera_fps():
    from core.camera import set_camera_fps
